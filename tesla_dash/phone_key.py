...
<body>
  <div class="wrap">
    ...
    <div class="card" id="ios-panel" hidden>
      ...
      <p class="lead" style="margin:0 0 .75rem">Safari’de Bluetooth yok. <strong>Swift Playgrounds → Run ▶</strong> ile iPhone’a <strong>yerel uygulama</strong> kurulur (Ana Ekran, CoreBluetooth). Mac şart değil. App Store .ipa bu sunucudan imzalanamaz.</p>
      <ol style="margin:0 0 .9rem;padding-left:1.15rem;color:rgba(255,255,255,.88);font-size:.88rem;line-height:1.45">
        ...
        <li>Zip indir → Dosyalar’da aç → <code>PulsePhoneKey.swiftpm</code> → Playgrounds’ta Aç</li>
      ...
      <p class="support" style="background:rgba(255,214,10,.12);color:#ffe566;margin-top:.75rem">
        <strong>SÜRÜM: build-14-iphone</strong> · Yerel app · ölü tunnel URL otomatik düzelir · Settings’te sunucu testi.
      </p>
...
def register_phone_key(server) -> None:
    ...
    def download_playgrounds_build7_zip():  # type: ignore[no-redef]
        return _send_release_zip("PulsePhoneKey-playground-build14.zip")
