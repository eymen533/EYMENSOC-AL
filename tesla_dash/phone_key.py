...
<body>
  <div class="wrap">
    ...
    <div class="card" id="ios-panel" hidden>
      ...
      <a class="btn" href="/downloads/PulsePhoneKey-playground-build20.zip" style="text-decoration:none;text-align:center">iPhone · build-20 Model Y + ikon rayı</a>
      ...
      <p class="support" style="background:rgba(255,214,10,.12);color:#ffe566;margin-top:.75rem">
        <strong>SÜRÜM: build-20-rails</strong> · Model Y lastik · medya ortalı · kaydırınca ikon rayı
      </p>
...
def register_phone_key(server) -> None:
    ...
    def download_playgrounds_build7_zip():  # type: ignore[no-redef]
        return _send_release_zip("PulsePhoneKey-playground-build20.zip", public=True)
