...
<body>
  <div class="wrap">
    ...
    <div class="card" id="ios-panel" hidden>
      ...
      <a class="btn" href="/downloads/PulsePhoneKey-playground-build23.zip" style="text-decoration:none;text-align:center">iPhone · build-23 Model Y + akıcı HUD</a>
      ...
      <p class="support" style="background:rgba(255,214,10,.12);color:#ffe566;margin-top:.75rem">
        <strong>SÜRÜM: build-23-fluid</strong> · Model Y lastik · akıcı kaydırma · güvenli harita
      </p>
...
def register_phone_key(server) -> None:
    ...
    def download_playgrounds_build7_zip():  # type: ignore[no-redef]
        return _send_release_zip("PulsePhoneKey-playground-build23.zip", public=True)
